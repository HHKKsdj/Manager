...
class PostViewController: UIViewController {
    ...
    func setUI() {
        ...
        announcement.titleLabel?.font = UIFont.systemFont(ofSize: 25)
        ...
        vote.titleLabel?.font = UIFont.systemFont(ofSize: 25)
        ...
        askQuestion.titleLabel?.font = UIFont.systemFont(ofSize: 25)
        ...
        draw.titleLabel?.font = UIFont.systemFont(ofSize: 25)
        ...
        registrationByTime.titleLabel?.font = UIFont.systemFont(ofSize: 25)
        ...
        registrationByGesture.titleLabel?.font = UIFont.systemFont(ofSize: 25)
